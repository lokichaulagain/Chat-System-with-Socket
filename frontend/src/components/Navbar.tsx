...
const Navbar = () => {
  return (
    <div className="col-9 ps-4 pe-5 py-3  d-flex align-items-center border-bottom position-fixed" style={{ backgroundColor: "#f3f2f2" }}>
      <div className="d-flex gap-2">
        <div>
          <Image src={profile} className="rounded-circle cp" width={40} height={40} alt="" />
        </div>
        <div className="">
      ...
      <div className="col d-flex align-items-center justify-content-end gap-4 text-muted">
        <input className="form-control  w-25" id="exampleFormControlInput1" placeholder="Search conversation" />
