        ...
        <div className="col-9 custom-bg-card-white rounded-3 pt-5 px-5  d-flex justify-content-center" style={{ height: "90vh" }}>
          <form action="" className="col-5">
            <div className="d-flex flex-column gap-2 align-items-center justify-content-center">
              ...
              <Image src={profile} className="rounded-circle " height={100} width={100} alt="img" />
            ...
            <div className="mt-3">
              ...
              <input type="password" className="form-control rounded-1 " id="oldPassword" placeholder="Enter Old Password" autoComplete="off" />
            </div>
            ...
            <div className="mt-3">
              ...
              <input type="password" className="form-control rounded-1 " id="newPassword" placeholder="Enter New Password" autoComplete="off" />
            </div>
            ...
            <div className="mt-3">
              ...
              <input type="password" className="form-control rounded-1 " id="confirmPassword" placeholder="Enter Confirm Password" />
            </div>

            <div className="row d-flex  mt-4">
              <div className="col-6 ">
                <button className="col-6 w-100 btn btn-primary py-2" type="button">
                  Save
                </button>
              </div>

              <div className="col-6">
                <button className="col-6 w-100 btn btn-primary py-2" type="button" onClick={() => router.push("/login")}>
                  Cancel
                </button>
              </div>
            </div>
